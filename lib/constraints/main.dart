...
class Example1 extends Example {
  ...
  @override
  Widget build(BuildContext context) {
    return PrintConstraints(child: Container(color: red));
  }
}
...
class Example2 extends Example {
  ...
  @override
  Widget build(BuildContext context) {
    return PrintConstraints(child: Container(width: 100, height: 100, color: red));
  }
}
...
class Example3 extends Example {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: PrintConstraints(child: Container(width: 100, height: 100, color: red)),
    );
  }
}
...
class Example11 extends Example {
  ...
  final String explanation = 'Center allows ConstrainedBox to be any size up to the screen size.'
      'The ConstrainedBox imposes ADDITIONAL constraints from its \'constraints\' parameter onto its child'
      '\n\n'
...
class Example12 extends Example {
  ...
  final String explanation = 'Center allow ConstrainedBox to be any size up to the screen size.'
