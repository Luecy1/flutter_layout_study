...
//                   Text("Processing state: " + "$processingState".replaceAll(RegExp(r'^.*\.'), '')),
//                   StreamBuilder(
...
//       stream: Rx.combineLatest2<double, double, double>(_dragPositionSubject.stream,
//           Stream.periodic(Duration(milliseconds: 200)), (dragPosition, _) => dragPosition),
//       builder: (context, snapshot) {
